...
const Profile = () => {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      toast.success('User Account Deleted Successfully!', { autoClose: 3000 });
    } catch (error) {
  ...
  const handleShowListings = async () => {
    try {
      ...
      if (data?.length === 0) toast.info("You Don't Have Any Listings!", { autoClose: 3000 });
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button
        ...
        className="bg-blue-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 w-full mt-2"
      >
        Show Listings
      </button>
